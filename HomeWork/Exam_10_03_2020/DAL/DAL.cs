...
namespace DALnamespace
{
    public class DAL
    {
        ...
        {
            var newObj = ctx.Shops.Where(q => q.DirectorId == obj.DirectorId).FirstOrDefault();
            newObj.Name = obj.Name;
        ...
        {
            Shops obj = ctx.Shops.Where(q => q.DirectorId == id).FirstOrDefault();
        ...
        //Workers
        public void CreateWorker(Workers c)
        {
            ctx.Workers.Add(c);
            ctx.SaveChanges();
        }
